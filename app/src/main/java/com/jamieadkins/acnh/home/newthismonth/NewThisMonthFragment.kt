...
class NewThisMonthFragment : DaggerFragment(), NewThisMonthContract.View {

    private var binding: FragmentCritterListBinding? = null
    @Inject lateinit var presenter: NewThisMonthContract.Presenter
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding?.toolbar?.setTitle(R.string.new_this_month)
    ...
    override fun showCrittersNewThisMonth(newThisMonth: BugFishSummaryEntity) {
        groupAdapter.update(mapCrittersToItems(newThisMonth))
    }
