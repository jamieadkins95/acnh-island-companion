...
class CropImageView @JvmOverloads constructor(
     ...
     */
    fun setCropOffset(horizontalOffsetPercent: Float = 0.5f, verticalOffsetPercent: Float = 0.5f) {
    ...
    private fun applyCropOffset() {
        ...
        // Get the scale.
        scale = if (drawableWidth * viewHeight > drawableHeight * viewWidth) { // Drawable is flatter than view. Scale it to fill the view height.
            // A Top/Bottom crop here should be identical in this case.
            viewHeight.toFloat() / drawableHeight.toFloat()
        } else { // Drawable is taller than view. Scale it to fill the view width.
